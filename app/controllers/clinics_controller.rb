...
class ClinicsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @clinic.save
        format.html { redirect_to @clinic, notice: 'Clínica foi criada com sucesso.' }
  ...
  def update
    ...
    respond_to do |format|
      if @clinic.update_attributes(params[:clinic])
        format.html { redirect_to @clinic, notice: 'Clínica foi atualizada com sucesso.' }
